...
/** 江湖敵手圖鑑：既有款＋新增十式（弓手／強盗等），側身望左，組成出敵池 */
export const ENEMY_POOL: EnemyDef[] = [
  ENEMY_SHADOW,
  SPAR_E('daoke', 616, 788, { x: -20, y: -520 }), // 黑衣刀客
  ...
  SPAR_E('gouke', 616, 788, { x: -20, y: -520 }), // 雙鉤客
  SPAR_E('qigai', 616, 788, { x: -18, y: -500 }, 0.97), // 丐幫
  SPAR_E('suoyi', 611, 788, { x: -8, y: -540 }, 0.98), // 蓑衣客
  SPAR_E('chifa', 616, 788, { x: -10, y: -510 }, 1.15), // 赤髮力士
  // —— 新增十式（獨特模型）——
  SPAR_E('gongshou', 616, 788, { x: -22, y: -530 }, 0.98), // 弓手
  SPAR_E('qiangdao', 616, 788, { x: -14, y: -505 }, 1.06), // 強盗
  SPAR_E('dunbing', 616, 788, { x: -8, y: -515 }, 1.08), // 盾兵
  SPAR_E('nuxia', 616, 788, { x: -16, y: -535 }, 0.95), // 女俠
  SPAR_E('shushi', 616, 788, { x: -12, y: -525 }, 0.97), // 書生
  SPAR_E('yiren', 616, 788, { x: -18, y: -520 }, 1.02), // 異人
  SPAR_E('yaoren', 616, 788, { x: -15, y: -510 }, 0.99), // 藥人
  SPAR_E('daoshi', 616, 788, { x: -10, y: -528 }, 1.0), // 道士
  SPAR_E('tongzi', 616, 788, { x: -12, y: -480 }, 0.82), // 童子
  SPAR_E('biaoshi', 616, 788, { x: -14, y: -522 }, 1.04), // 鏢師
];
