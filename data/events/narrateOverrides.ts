...
export const NARRATE_OVERRIDES: Record<string, string> = {
  ...
  'sect_training::rest': '你偷得半日清閒，聽師兄師姐閒話門中舊事。招式沒多練幾遍，門道倒是聽懂了幾分。',
  ...
  'duel_street::fight': '街沿圍觀的人讓出一圈。刀光只交手三合，對方一個踉蹌退到牆邊，你收刀入鞘。',
  ...
  'martial_tournament::enter': '號炮響，你連勝三場，最後一擊挑飛對手兵刃。全場叫好聲裡，你抱拳謝場。',
  ...
  'gamble::play': '骰子滾停，點數正合你意。莊家臉一僵，把一疊銅錢推到你面前。',
  ...
  'caravan_guard::guard': '鏢車碾過官道石子，你跟在車側，一路無事到了地頭，賞錢比說好的還多給了一成。',
  ...
  'final_duel::all_in': '你把最後一口氣壓進丹田，刀鋒對著對方咽喉。這一戰沒有退路，也不留餘地。',
  'final_duel::retire': '金盆水涼。你把刀橫在盆沿，聽水聲一圈圈散開——門外有人等著看你洗不洗手。',
  'inheritance::pass': '族規寫在粗紙上。你蓋印時手穩，紙邊卻被風掀起一角。',
  'random_fortune::pay': '先生搖卦，銅錢響了三下。他說的話你只記住半句，其餘散在茶煙裡。',
  'kidnap_plot::rescue': '你趁夜摸進柴房，割斷繩索，背起人質翻牆而出。巷口的狗叫了兩聲，沒人追出來。',
  'peaceful_year::rest': '這一年沒大事。你修了院牆，曬了兩回醬，枕邊多了一本看完的話本。',
  'accident_fall::lucky': '腳下一空，你伸手死死攥住一截藤蔓，指節發白。爬上崖頂時，膝蓋還在抖。',
